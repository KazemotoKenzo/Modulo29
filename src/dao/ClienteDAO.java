...
public class ClienteDAO extends GenericDAO<Cliente> implements IClienteDAO{
    ...
    @Override
    protected void mapStatementForCreate(PreparedStatement stm, Cliente entity) throws SQLException {
        stm.setString(1, entity.getCodigo());
        stm.setString(2, entity.getNome());
    }

    @Override
    protected void mapStatementForUpdate(PreparedStatement stm, Cliente entity) throws SQLException {
        stm.setString(1, entity.getCodigo());
        stm.setString(2, entity.getNome());
    ...
    @Override
    protected void mapStatementForDelete(PreparedStatement stm, Cliente entity) throws SQLException {
        stm.setString(1, entity.getCodigo());
    }
